...
def test_gecko_has_six_distinct_code_authored_motion_scenes():
    ...
    assert ANIMATION_VERSION == "p68.scientific_animation.v4"
...
def test_animation_renderer_adds_review_compatible_silent_audio():
    source = (ROOT / "src" / "p68_scientific_animation.py").read_text()
    assert "anullsrc=channel_layout=stereo:sample_rate=48000" in source
